...
os = 'mac';
%% Path preferences
% % cd('C:\Users\arush\Desktop\MR_INDIA_CODE\pulseq-master_All\matlab\Sequences'); 
% %addpath(genpath('/Users/Sairam/Desktop/Periodic_assesments/Career/Change2excel/Sabbatical/Tools/pulseq-master_All'));
